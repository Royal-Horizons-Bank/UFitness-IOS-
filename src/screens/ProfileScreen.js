    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.navRow}>
          ...
          <TouchableOpacity 
            // <-- FIXED: Updated navigation hook syntax for Settings
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.bodyRow}>
            <BodyCard 
              ...
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/bodystats', params: { metric: 'weight', label: 'Weight History', color: '#30D158' }})}
            />
            <View style={{width: 12}} />
            <BodyCard 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/bodystats', params: { metric: 'height', label: 'Height History', color: '#BF5AF2' }})}
            />
          </View>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.statsList}>
            <QuickStat 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/history', params: { metric: 'workouts', label: 'Workouts', color: '#FF2D55', unit: 'workouts' }})}
            />
            <QuickStat 
              label="Total Steps" 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/history', params: { metric: 'steps', label: 'Steps', color: colors.danger, unit: 'steps' }})}
            />
            <QuickStat 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/history', params: { metric: 'calories', label: 'Active Energy', color: '#FF9500' }})}
            />
            <QuickStat 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/history', params: { metric: 'minutes', label: 'Active Minutes', color: '#5856D6', unit: 'mins' }})}
            />
            <QuickStat 
              label="Hydration" 
              ...
              colors={colors} styles={styles}
              // <-- FIXED: Updated navigation parameters for Expo Router
              onPress={() => router.push({ pathname: '/history', params: { metric: 'hydration', label: 'Hydration', color: '#0A84FF' }})}
            />
          </View>
        </View>
